...
const Footer = () => {
  return (
    <div className='flex flex-col items-start justify-center gap-2 md:flex-row md:justify-between md:items-center'>
      <section className='flex items-center justify-start gap-2 pl-3'>
