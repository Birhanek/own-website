  ...
  return (
    <div className='sticky top-0 left-0 z-50 flex items-center justify-between gap-1 bg-gray-200 shadow-2xl '>
        ...
        <ul className={isExpanded? 'flex absolute w-full bg-slate-900 top-16 left-0 z-10 flex-col h-min':'hidden md:flex md:justify-between md:gap-4 md:items-center md:p-4'}>
                <li className='p-2 text-white md:text-gray-800'><a className='p-2 hover:font-bold hover:text-amber-900 hover:italic' href='#home'>Home</a></li>
                <li className='p-2 text-white md:text-gray-800'><a className='p-2 hover:font-bold hover:text-amber-900 hover:italic' href='#about'>About</a></li>
                <li className='p-2 text-white md:text-gray-800'><a className='p-2 hover:font-bold hover:text-amber-900 hover:italic' href='#work'>Work</a></li>
                <li className='p-2 text-white md:text-gray-800'><a className='p-2 hover:font-bold hover:text-amber-900 hover:italic' href='#contact'>Contact me</a></li>
        </ul>
